...
const [isOpen, setIsOpen] = useState(false)
  return (
    ...
    <Link href='/' className='lg:hidden'>
        ...
        <Image src= '/800px-Instagram_logo_2016.webp' width ={96} height = {96} alt ='instagram logo' />
    ...
    {session ? (
      ...
      <IoMdAddCircleOutline className='text-2xl cursor-pointer transform hover:scale-125 transition duration-300 hover:text-red-600'
   ...
   {isOpen && (
    <Modal isOpen= {isOpen} className='max-w-lg w-[90%] p-6 absolute top-56 left-[50%]  bg-white border-2 rounded-md shadow-md'
    ...
    ariaHideApp={false}>     
      ...
      <div className='flex flex-col justify-center items-center h-[100%]'>
       ...
       <button disabled className='w-full bg-red-600 text-white p-2 shadow-md rounded-lg hover:brightness-105 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:hover:brightness-100' >Upload Post
       </button>
